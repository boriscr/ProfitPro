...
const translations = {
    es: {
        ...
        calcular: 'Calcular',
        bandera: '🇪🇸', // O el path a tu imagen de España
        monto: "Monto:",
        plazo: "Plazo (Meses):",
        interesAnual: "Interés (Anual %):",
        montoExtra: "Monto Extra (Al finalizar el plazo):",
        montoDescontar: "Monto a Descontar (Al finalizar el plazo):",
    ...
    en: {
        ...
        fci: 'Mutual Funds',
        calcular: 'Calculate',
        bandera: '🇺🇸', // O el path a tu imagen de EEUU
        monto: "Amount:",
        plazo: "Term (Months):",
        interesAnual: "Annual Interest (%):",
        montoExtra: "Extra Deposit (At maturity):",
        montoDescontar: "Amount to Deduct (At maturity):",
